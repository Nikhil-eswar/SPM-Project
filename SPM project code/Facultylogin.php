...
$dbname = "student-faculty"; // database name
...
if ($_SERVER['REQUEST_METHOD']=="POST"){    
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT * FROM faculty_cred WHERE name1 = '$first_name' AND  pass = '$password'";
    ...
    if($count > 0){
        ...
        $_SESSION["login_F"]="1";
        $_SESSION["uname_F"]=$first_name;
        header(
            'Location:FacultyHomeScreen.php'
        );
    } 
    else{
        ...
        <div class="row">
            <div class="col-lg-12">
                <div id="centering">
                    <h1>Faculty Login</h1>
                    <div id="bag">
                        <form id="forml"action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method = "POST">
                            <div >
                              <label for="name">Faculty ID: </label>
                              <input type="text" name="name1" id="name1" placeholder="Registration Id" required>
                                <span>*<?php echo $usererror; ?></span>

                            </div>
                            <div >
                              <label for="Password">Password.  : </label>
                              <input type="Password" name="pass" id="pass" pattern=".{5,10}" placeholder="5-10 characters" required title="5 to 10 characters">
